...
?>
	<div align="center": style="color: #000000; background-color: #9999ff; border: thin solid #000044; width: 100%; height: 20px">
<?php
...
<?php
	  if ($showButton==true) {
?>
	  <p align="center"><input type="submit" value="Apply settings" name="btnApply"></p>
	  <input type="submit" value="Reset settings" name="btnReset">
	  <input type="submit" value="Refresh settings" name="btnRefresh"></br>
<?php
	  } else {
?>
	  <p align="center"><input type="submit" value="Reset settings" name="btnReset"></p>
	  <input type="submit" value="Refresh settings" name="btnRefresh"></br>
<?php
   }
?>
